...
def announce_node(state: AgentState):
    system = SystemMessage(content=(
        "You are a friendly robot assistant. Briefly announce in 1 sentence what you are "
        "about to do based on the plan. Be concise and friendly."
    ))
...
if __name__ == "__main__":
    ...
    time.sleep(3)
    motion.say("Hello Please type in the terminal what you want me to do")
    ...
    while True:
        ...
        motion.say("I'm done, what else would you like me to do?")
        time.sleep(4.0)  # wait for speech to finish
